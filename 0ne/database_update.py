...
def update():
    ...
    conn.commit()
    conn.close()
    #destroying all the data and closing function\
    editor.destroy()
...
name_label = Label(root, text="Id No.")
...
update_button.grid(row=8,column=0, columnspan=2, padx=10, pady=10, ipadx=100)
